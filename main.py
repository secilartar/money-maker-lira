...
- Fon Değişimleri Haftalıktır: Fon portföy dağılımları ve hisse ağırlık değişimleri her hafta yayımlanır. Bu nedenle fon pozisyonlarındaki değişimlerden bahsederken "son dönemde" veya "geçenlerde" gibi muğlak ifadeler yerine her zaman "haftalık bazda", "geçen haftaya göre" veya "son açıklanan haftalık rapora göre" ifadelerini kullan.
